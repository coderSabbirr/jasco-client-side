                ...
                <div className="container ">
                    <form className="row  addproduct-from" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="col-md-12">
                            ...
                            <input type="name" className="form-control"  {...register("title", { required: true })} />
                        </div>
                        ...
                        <div className="col-6">
                            ...
                            <input type="text" className="form-control"   {...register("rate", { required: true })} />
                        </div>
                        <div className="col-6">
                            <label className="form-label">Count </label>
                            <input type="text" className="form-control"   {...register("count", { required: true })} />
                        </div>
                        <div className="col-12">
                            <label className="form-label">Description </label>
                            <textarea id="w3review" rows="4" cols="50" type="text" className="form-control"  {...register("description", { required: true })} />
                        </div>
                        <div className="col-md-12">
