        ...
        <div >
            ...
            <form className="review-from"  onSubmit={handleSubmit(onSubmit)} >
                ...
                <div className="col-md-12">
                    ...
                    <input type="name" className="form-control"  {...register("rating", { required: true })} />
                </div>

                <div className="col-12">
                    <label className="form-label"> Review deatil </label>
                    <textarea id="w3review" placeholder="Please share your feedback about the product:
Was the product as described? What is the quality like?" rows="4" cols="50" type="text" className="form-control"  {...register("description", { required: true })} />
                </div>
